                    ...
                    <div className='h-fit grid grid-cols-4 gap-1'>
                        {articles.map((article: any) => (
                            <Link to={`/article/${article.id}`}>
                                <div className='rounded-lg border h-[250px] border-yellow-300/20 overflow-hidden shadow-lg text-left mb-2 p-5 m-5 bg-slate-200/20 bg-opacity-50 text-slate-300' key={article.id}>
